  ...
  return (
    <div className="w-full relative z-10 text-foreground">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">View and manage all servers across the panel.</p>
      </div>
        ...
        {editingServer && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <motion.div 
              ...
              className="bg-[#121214] border border-border rounded-2xl p-5 max-w-md w-full"
            >
        ...
        {deletingServer && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <motion.div 
              ...
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.95 }}
              className="bg-[#121214] border border-red-500/30 rounded-2xl p-5 max-w-md w-full"
            >
        ...
        {open && (
          ...
          >
            <button 
              ...
              className="flex items-center px-3 py-2 text-sm text-foreground-muted hover:bg-muted hover:text-foreground transition-colors text-left"
            >
            ...
            <button 
              ...
              className="flex items-center px-3 py-2 text-sm text-red-400 hover:bg-red-500/10 hover:text-red-300 transition-colors text-left"
            >
