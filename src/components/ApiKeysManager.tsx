...
export default function ApiKeysManager() {
  ...
  return (
    <div className="bg-card border border-border-subtle rounded-2xl p-4 md:p-5 shadow-xl mt-8">
      ...
      {apiKeys.length === 0 ? (
        <div className="text-center p-5 border border-border-subtle bg-muted-subtle rounded-xl">
