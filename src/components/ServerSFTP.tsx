  ...
  return (
    <div className="flex-1 p-5 overflow-y-auto custom-scrollbar">
      <div className="max-w-4xl mx-auto space-y-4">
        ...
        {!sftpInfo ? (
          <div className="qx-glass border border-border-subtle p-6 rounded-2xl flex flex-col items-center justify-center text-center">
            ...
            <button
              ...
              className="px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-foreground font-bold rounded-xl transition-colors shadow-lg shadow-indigo-500/20"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-4">
              <div className="qx-glass border border-border-subtle rounded-2xl p-5 relative overflow-hidden group">
            ...
            <div className="space-y-4">
              <div className="qx-glass border border-border-subtle rounded-2xl p-5">
        ...
        {showConfirmReset && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <motion.div 
              ...
              className="bg-[#121214] border border-orange-500/30 shadow-2xl shadow-orange-500/10 rounded-2xl p-5 max-w-md w-full relative overflow-hidden"
            >
