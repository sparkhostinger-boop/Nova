...
export default function ServerSettings({ serverId, server }: { serverId: string, server: any }) {
  ...
  return (
    <>
      {showDowngradeRestartPopup && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-black/60 backdrop-blur-2xl border border-border p-5 md:p-6 rounded-3xl max-w-md w-full shadow-[0_0_50px_-10px_rgba(0,0,0,0.8)] ring-1 ring-border-subtle relative overflow-hidden">
            ...
            <div className="flex justify-end mt-6">
              <button
                ...
                className="px-4 py-2 bg-amber-500 hover:bg-amber-400 text-black font-semibold rounded-xl transition-all disabled:opacity-50"
              >
    ...
    <div className="flex-1 overflow-y-auto p-4 md:p-6 custom-scrollbar text-foreground bg-transparent">
      <div className="max-w-3xl space-y-8">
        ...
        {canManage ? (
          <>
            <div className="bg-black/40 dark:bg-black/40 backdrop-blur-xl border border-border p-5 md:p-6 rounded-3xl shadow-[0_0_40px_-15px_rgba(0,0,0,0.5)] ring-1 ring-border-subtle relative z-30 group hover:bg-black/60 transition-colors mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex items-end">
                  <button 
                    ...
                    className="px-4 py-2 bg-amber-500/10 hover:bg-amber-500/20 text-amber-500 font-medium rounded-xl border border-amber-500/20 transition-all disabled:opacity-50 flex items-center min-w-[160px] justify-center h-[50px]"
                  >
            ...
            <div className="bg-black/40 dark:bg-black/40 backdrop-blur-xl border border-border p-5 md:p-6 rounded-3xl shadow-[0_0_40px_-15px_rgba(0,0,0,0.5)] ring-1 ring-border-subtle relative z-20 group hover:bg-black/60 transition-colors mb-8">
            ...
            {user?.role === "admin" ? (
              <>
                ...
                <div className="bg-black/40 dark:bg-black/40 backdrop-blur-xl border border-border p-5 md:p-6 rounded-3xl shadow-[0_0_40px_-15px_rgba(0,0,0,0.5)] ring-1 ring-border-subtle relative z-10 group hover:bg-black/60 transition-colors">
                  <h3 className="text-indigo-400 font-bold mb-2 flex items-center">
