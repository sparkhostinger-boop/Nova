  ...
  return (
    ...
    >
      <div className="mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight text-foreground mb-2">Deploy Instance</h1>
          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              <motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-foreground-muted mb-2">Instance Name</label>
                  <input
                    type="text"
                    required
                    value={name}
